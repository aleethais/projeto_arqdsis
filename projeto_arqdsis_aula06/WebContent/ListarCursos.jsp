                                ...
                                <% ArrayList<CursoTO>lista = (ArrayList
                                    <CursoTO>)request.getAttribute("lista"); for(CursoTO to:lista){ %>
                                       <tr>
                                            ...
                                            <td class="actions">
                                                <a class="btn btn-success btn-xs" href="ManterCurso.do?acao=Visualizar&id=<%=to.getId()%>">Visualizar</a>
                                                <a class="btn btn-warning btn-xs" href="ManterCurso.do?acao=Editar&id=<%=to.getId()%>">Editar</a>
